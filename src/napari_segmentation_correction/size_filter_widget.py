...
class SizeFilterWidget(QWidget):
    ...
    def __init__(
        ...
        self.delete_btn.setEnabled(isinstance(self.label_manager.selected_layer, napari.layers.Labels))
        self.label_manager.layer_update.connect(
            lambda: self.delete_btn.setEnabled(isinstance(self.label_manager.selected_layer, napari.layers.Labels))
        )
