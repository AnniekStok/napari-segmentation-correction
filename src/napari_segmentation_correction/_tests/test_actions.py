...
class TestProcessAction3D:
    ...
    def test_3d_numpy_single_frame(self):
        ...
        result = process_action(
            seg, mask, dummy_action_with_mask, img1_index=1, img2_index=None, in_place=False
        )
    ...
    def test_3d_dask_single_frame(self):
        ...
        mask = np.ones((4, 4), dtype=np.uint8)
        result = process_action(
            seg_dask, mask, dummy_action_with_mask, img1_index=1, img2_index=None, in_place=False
        )
...
class TestProcessAction2D:
    ...
    def test_2d_numpy_no_indices(self):
        ...
        mask = np.ones((4, 4), dtype=np.uint8)
        result = process_action(
            seg, mask, dummy_action_with_mask, in_place=False
        )
...
class TestProcessActionEdgeCases:
    ...
    def test_no_copy_when_not_in_place(self):
        ...
        original_id = id(seg)
        result = process_action(
            seg, mask, dummy_action_with_mask, img1_index=[0, 1, 2], img2_index=None, in_place=False
        )
