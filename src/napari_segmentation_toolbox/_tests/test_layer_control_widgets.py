...
from napari_segmentation_toolbox.layer_control_widgets import (
...
def test_save_labels(make_napari_viewer, qtbot, img_4d, tmp_path):
    ...
    with patch(
        "napari_segmentation_toolbox.layer_control_widgets.save_labels_widget.QFileDialog.getExistingDirectory"
    ) as mock_dialog:
