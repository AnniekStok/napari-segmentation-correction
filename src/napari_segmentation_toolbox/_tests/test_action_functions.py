...
from napari_segmentation_toolbox.tool_widgets.image_calculator import (
    add_images,
    divide_images,
    logical_and,
    logical_or,
...
from napari_segmentation_toolbox.tool_widgets.label_boundaries import (
    compute_boundaries,
)
from napari_segmentation_toolbox.tool_widgets.smoothing_widget import median_filter
from napari_segmentation_toolbox.tool_widgets.threshold_widget import threshold
...
def test_threshold(img_2d, img_3d, img_4d, tmp_path):
    ...
    with patch(
        "napari_segmentation_toolbox.helpers.process_actions_helpers.QFileDialog.getExistingDirectory"
    ) as mock_dialog:
